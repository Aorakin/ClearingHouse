...
func MapQuotaRoutes(quotaGroup *gin.RouterGroup, quotaHandler interfaces.QuotaHandler) {
	...
	quotaGroup.GET("/project/:project-id", quotaHandler.GetProjectQuota())
	quotaGroup.GET("/project/:project-id/namespaces", quotaHandler.GetNamespaceQuotaInProject())
	quotaGroup.POST("/namespace", quotaHandler.CreateNamespaceQuota())
	quotaGroup.GET("/namespace/:namespace-id", quotaHandler.GetNamespaceQuota())
