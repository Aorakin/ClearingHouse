...
func MapQuotaRoutes(quotaGroup *gin.RouterGroup, quotaHandler interfaces.QuotaHandler) {
	...
	quotaGroup.PUT("/organization/:quota_id", quotaHandler.UpdateOrganizationQuota())
	...
	quotaGroup.GET("/project/:project_id/total", quotaHandler.GetProjectQuotaTotal())
	quotaGroup.GET("/project/:project_id/namespaces", quotaHandler.GetNamespaceQuotaInProject())
	quotaGroup.PUT("/project/:quota_id", quotaHandler.UpdateProjectQuota())
	quotaGroup.POST("/project/internal", quotaHandler.CreateInternalProjectQuota())
	quotaGroup.PUT("/project/internal/:quota_id", quotaHandler.UpdateInternalProjectQuota())
	...
	quotaGroup.PUT("/namespace/:quota_id", quotaHandler.UpdateNamespaceQuota())
