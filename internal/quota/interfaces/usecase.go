...
type QuotaUsecase interface {
	...
	GetNamespaceQuota(namespaceID uuid.UUID, userID uuid.UUID) ([]dtos.NamespaceQuotaResponse, error)
	...
	GetNamespaceQuotaTemplate(quotaTemplateID uuid.UUID, userID uuid.UUID) (*models.NamespaceQuotaTemplate, error)
